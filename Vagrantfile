...
config.vm.synced_folder "./conf", "/etc/tomcat7", create:true, owner: "root", group: "root", mount_options: ["dmode=777,fmode=666"]
config.vm.synced_folder "./log", "/var/log/tomcat7", create:true, owner: "root", group: "root", mount_options: ["dmode=777,fmode=666"]
